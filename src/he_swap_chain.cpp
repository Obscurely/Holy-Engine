...
VkResult HESwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult HESwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                           uint32_t *imageIndex) {
...
void HESwapChain::createSwapChain() {
...
void HESwapChain::createImageViews() {
...
void HESwapChain::createRenderPass() {
...
void HESwapChain::createFramebuffers() {
...
void HESwapChain::createDepthResources() {
...
void HESwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR HESwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR HESwapChain::chooseSwapPresentMode(
...
VkExtent2D
HESwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat HESwapChain::findDepthFormat() {
