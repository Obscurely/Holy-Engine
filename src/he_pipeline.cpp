...
void HEPipeline::createGraphicsPipeline(const std::string &vertFilepath,
  ...
  auto bindingDescriptions = HEModel::Vertex::getBindingDescriptions();
  auto attributeDescriptions = HEModel::Vertex::getAttributeDescriptions();
  ...
  if (vkCreateGraphicsPipelines(heDevice.device(), VK_NULL_HANDLE, 1,
...
void HEPipeline::defaultPipelineConfigInfo(PipelineConfigInfo &configInfo) {
